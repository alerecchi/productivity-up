...
The current PostgreSQL integration suite runs when `DATABASE_URL` is present and reports as skipped otherwise. See [Cloudflare deployments](docs/deployment.md) for the separate migration, staging, and production prerequisites.
